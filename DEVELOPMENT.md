...
```bash
git remote add encore encore://leap-app-wnsi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/leap-app-wnsi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/leap-app-wnsi/settings/integrations/github)
